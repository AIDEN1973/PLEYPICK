...
class LegoSetRenderer:
    ...
    def render_set(self, set_num, ldraw_path, output_dir, images_per_part=5):
        ...
        for part_data in set_parts:
            ...
            print(f"\n🔧 부품 렌더링: {part_id} (색상: {color_id}, 수량: {quantity})")
            ...
            for i in range(images_per_part):
                ...
                # 렌더링
                output_filename = f"{set_num}_{part_id}_{color_id}_{i:03d}.png"
...
def main():
    ...
    parser.add_argument('--output-dir', default='./output/sets', help='출력 디렉토리')
