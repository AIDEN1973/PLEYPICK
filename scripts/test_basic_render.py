#!/usr/bin/env python3
"""
🧱 BrickBox 기본 렌더링 테스트 스크립트

LDraw 없이 기본 도형으로 렌더링 파이프라인 테스트
- 기본 큐브 생성
- 재질 및 조명 설정
- 렌더링 테스트
"""
...
def main():
    ...
    # 랜덤 재질 적용
    color = apply_random_material(cube)
    
    # 랜덤 회전 적용
    rotation = apply_random_rotation(cube)
    
    # 렌더링
    output_path = os.path.join(output_dir, "test_cube.png")
